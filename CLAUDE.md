...
**→ FIRST: publish the Round Numbers letdowns article (Sunday Jul 20 evening).** The P6 data article is DRAFTED and review-ready (`packages/web/src/content/posts/2026-07-18-biggest-fight-letdowns-2026.md`, `draft: true`; preview in admin.html → Blog → Drafts). Publish flow: Mike approves → flip `draft: false` + push → verify `/blog/biggest-fight-letdowns-2026` live with hero + og stat card → fill [ARTICLE URL] into `docs/marketing/pitches/letdowns-2026-pitch-emails.md` → Mike sends pitches Monday Jul 21 morning (personally, NO Reddit). Series = **"Round Numbers: data stories from combat sports"** (quarterly; engine: `packages/backend/scripts/hype-vs-reality.ts` — pre-fight-only votes, test accounts excluded). Full context: `docs/daily/2026-07-18.md` session 2.
