...
// Legacy tag ID to name mapping (from fightingtomatoes.com)
// These are the common tags used in the legacy system
const LEGACY_TAG_NAMES: Record<string, string> = {
  '1': 'Fight of the Night',
  '2': 'Performance of the Night',
  '3': 'Knockout of the Night',
  '4': 'Submission of the Night',
  '5': 'Great Grappling',
  '6': 'Great Striking',
  '7': 'Comeback',
  '8': 'Upset',
...
const TAG_CATEGORY_MAP: Record<string, 'STYLE' | 'PACE' | 'OUTCOME' | 'EMOTION' | 'QUALITY'> = {
  'Fight of the Night': 'QUALITY',
  'Performance of the Night': 'QUALITY',
  'Knockout of the Night': 'QUALITY',
  'Submission of the Night': 'QUALITY',
