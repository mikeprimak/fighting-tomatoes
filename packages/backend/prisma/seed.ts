...
async function main() {
  ...
  const usersData = [
    ...
    {
      email: 'one@fightingtomatoes.com',
      password: hashedPassword,
      displayName: 'One',
      isEmailVerified: true,
      authProvider: AuthProvider.EMAIL,
    ...
    {
      email: 'two@fightingtomatoes.com',
      password: hashedPassword,
      displayName: 'Two',
      isEmailVerified: true,
      authProvider: AuthProvider.EMAIL,
    ...
    {
      email: 'three@fightingtomatoes.com',
      password: hashedPassword,
      displayName: 'Three',
      isEmailVerified: true,
      authProvider: AuthProvider.EMAIL,
    ...
    {
      email: 'four@fightingtomatoes.com',
      password: hashedPassword,
      displayName: 'Four',
      isEmailVerified: true,
      authProvider: AuthProvider.EMAIL,
    ...
    {
      email: 'five@fightingtomatoes.com',
      password: hashedPassword,
      displayName: 'Five',
      isEmailVerified: true,
      authProvider: AuthProvider.EMAIL,
    ...
    {
      email: 'six@fightingtomatoes.com',
      password: hashedPassword,
      displayName: 'Six',
      isEmailVerified: true,
      authProvider: AuthProvider.EMAIL,
