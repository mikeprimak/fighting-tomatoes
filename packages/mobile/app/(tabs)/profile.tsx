...
export default function ProfileScreen() {
  ...
  // salt as the home mirror so the noun here matches the greeting pill.
  ...
  useEffect(() => {
    const fetchFanDNA = async () => {
      ...
      try {
        ...
        // insights, and matching the mirror's args keeps the two nouns equal.
  ...
  return (
    <SafeAreaView style={styles.container} edges={['left', 'right']}>
      ...
      >
        ...
        {/* Your Fan DNA — rotating identity noun (matches the home mirror's
            pill), top taste insight as fallback. Voice: the claim stands on
