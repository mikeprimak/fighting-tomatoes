---
title: "UFC Card Placement Rankings: Who the UFC Books Highest"
...
MMA Analyst Chael Sonnen says placement on the card is more important than rank. Fighting high on the card means more media and fan attention on your fight, which means opportunity for you. His advice to young fighters is - ignore the rankings, mind card placement. So, for fans and fighters alike, here are UFC placement on the card rankings.
...
2. Gilbert Burns: **1**
3. Israel Adesanya: **1**
4. Gabriel Bonfim: **1.3**
5. Belal Muhammad: **1.3**
6. Song Yadong: **1.3**
7. Carlos Ulberg: **1.3**
8. Lerone Murphy: **1.3**
9. Caio Borralho: **1.3**
...
The data runs back to 1993, so the same idea applies across whole careers. These are the fighters with the most UFC main events ever:

1. Anderson Silva: 18
2. Jon Jones: 17 (every one a numbered card, the most in UFC history)
3. Israel Adesanya: 15
4. [Max Holloway](/blog/max-holloway-career-explained): 15
5. Stipe Miocic: 13
6. Derrick Lewis: 13
7. Dustin Poirier: 13
...
Here is a pattern worth knowing: once a fighter starts headlining Fight Night cards, a big opportunity is usually right around the corner. The fighter at the top of a division's Fight Night list is normally the hottest contender, a win or two from a title shot.
