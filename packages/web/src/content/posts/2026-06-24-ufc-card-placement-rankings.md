...
13. Paddy Pimblett: **1.7**
14. Alexandre Pantoja: **1.7**
15. Kai Kara-France: **1.7**
16. Jamahal Hill: **1.7**
...
<div style="flex:1;display:flex;flex-direction:column;align-items:center;justify-content:flex-end;height:100%;"><span style="font-size:12px;font-weight:700;color:#9aa0a6;margin-bottom:5px;">7</span><span style="width:100%;background:#F5C518;border-radius:3px 3px 0 0;height:25%;"></span></div>
<div style="flex:1;display:flex;flex-direction:column;align-items:center;justify-content:flex-end;height:100%;"><span style="font-size:12px;font-weight:700;color:#9aa0a6;margin-bottom:5px;">12</span><span style="width:100%;background:#F5C518;border-radius:3px 3px 0 0;height:43%;"></span></div>
<div style="flex:1;display:flex;flex-direction:column;align-items:center;justify-content:flex-end;height:100%;"><span style="font-size:12px;font-weight:700;color:#9aa0a6;margin-bottom:5px;">12</span><span style="width:100%;background:#F5C518;border-radius:3px 3px 0 0;height:43%;"></span></div>
<div style="flex:1;display:flex;flex-direction:column;align-items:center;justify-content:flex-end;height:100%;"><span style="font-size:12px;font-weight:700;color:#9aa0a6;margin-bottom:5px;">25</span><span style="width:100%;background:#F5C518;border-radius:3px 3px 0 0;height:90%;"></span></div>
<div style="flex:1;display:flex;flex-direction:column;align-items:center;justify-content:flex-end;height:100%;"><span style="font-size:12px;font-weight:700;color:#9aa0a6;margin-bottom:5px;">12</span><span style="width:100%;background:#F5C518;border-radius:3px 3px 0 0;height:43%;"></span></div>
<div style="flex:1;display:flex;flex-direction:column;align-items:center;justify-content:flex-end;height:100%;"><span style="font-size:12px;font-weight:700;color:#9aa0a6;margin-bottom:5px;">18</span><span style="width:100%;background:#F5C518;border-radius:3px 3px 0 0;height:65%;"></span></div>
<div style="flex:1;display:flex;flex-direction:column;align-items:center;justify-content:flex-end;height:100%;"><span style="font-size:12px;font-weight:700;color:#9aa0a6;margin-bottom:5px;">10</span><span style="width:100%;background:#F5C518;border-radius:3px 3px 0 0;height:36%;"></span></div>
<div style="flex:1;display:flex;flex-direction:column;align-items:center;justify-content:flex-end;height:100%;"><span style="font-size:12px;font-weight:700;color:#9aa0a6;margin-bottom:5px;">9</span><span style="width:100%;background:#F5C518;border-radius:3px 3px 0 0;height:32%;"></span></div>
</div>
...
4. Israel Adesanya: **1**
5. Kamaru Usman: **1.3**
6. Belal Muhammad: **1.3**
7. Gabriel Bonfim: **1.3**
8. Song Yadong: **1.3**
9. Carlos Ulberg: **1.3**
10. Lerone Murphy: **1.3**
11. Caio Borralho: **1.3**
12. Anthony Hernandez: **1.3**
13. Amir Albazi: **1.3**
14. Petr Yan: **1.3**
15. Mackenzie Dern: **1.3**
16. Reinier De Ridder: **1.3**
17. Nassourdine Imavov: **1.3**
...
<li>Rizvan Kuniev: <strong>4.3</strong></li>
...
<div class="division-col">
<h3>Big Event Fighters</h3>
<div style="display:flex;align-items:center;gap:14px;margin:14px 0 22px;padding:14px 16px;border:1px solid #2b2b2b;border-radius:14px;background:linear-gradient(135deg,#1b1b1b,#0f0f0f);"><img src="https://pub-7bef67fde2894e1eb3061dee36bde224.r2.dev/fighters/jamahal-hill-02c55968.png" alt="Jamahal Hill" width="72" height="72" loading="lazy" style="width:72px;height:72px;border-radius:12px;object-fit:cover;background:#262626;flex:none;" /><div style="min-width:0;"><div style="font-size:18px;font-weight:700;color:#fff;line-height:1.25;">Jamahal Hill</div><div style="font-size:13px;color:#9aa0a6;">Avg. card placement 1.7</div></div></div>
<ol>
<li>Jamahal Hill: <strong>1.7</strong></li>
<li>Paulo Costa: <strong>2</strong></li>
<li>Jiri Prochazka: <strong>2.3</strong></li>
<li>Robert Whittaker: <strong>3</strong></li>
<li>Dominick Reyes: <strong>3.3</strong></li>
<li>Bogdan Guskov: <strong>4</strong></li>
<li>Jan Blachowicz: <strong>4.3</strong></li>
<li>Azamat Murzakanov: <strong>4.7</strong></li>
<li>Jim Crute: <strong>5.7</strong></li>
<li>Nikita Krylov: <strong>6.3</strong></li>
</ol>
</div>
<div class="division-col">
<h3>Fight Night Fighters</h3>
<div style="display:flex;align-items:center;gap:14px;margin:14px 0 22px;padding:14px 16px;border:1px solid #2b2b2b;border-radius:14px;background:linear-gradient(135deg,#1b1b1b,#0f0f0f);"><img src="https://pub-7bef67fde2894e1eb3061dee36bde224.r2.dev/fighters/magomed-ankalaev-b8561910.png" alt="Magomed Ankalaev" width="72" height="72" loading="lazy" style="width:72px;height:72px;border-radius:12px;object-fit:cover;background:#262626;flex:none;" /><div style="min-width:0;"><div style="font-size:18px;font-weight:700;color:#fff;line-height:1.25;">Magomed Ankalaev</div><div style="font-size:13px;color:#9aa0a6;">Avg. card placement 1.0</div></div></div>
<ol>
<li>Magomed Ankalaev: <strong>1</strong></li>
...
<li>Billy Elekana: <strong>6.3</strong></li>
</ol>
</div>
</div>
...
<div class="division-col">
<h3>Big Event Fighters</h3>
<div style="display:flex;align-items:center;gap:14px;margin:14px 0 22px;padding:14px 16px;border:1px solid #2b2b2b;border-radius:14px;background:linear-gradient(135deg,#1b1b1b,#0f0f0f);"><img src="https://pub-7bef67fde2894e1eb3061dee36bde224.r2.dev/fighters/dricus-du-plessis-5e37d91c.png" alt="Dricus Du Plessis" width="72" height="72" loading="lazy" style="width:72px;height:72px;border-radius:12px;object-fit:cover;background:#262626;flex:none;" /><div style="min-width:0;"><div style="font-size:18px;font-weight:700;color:#fff;line-height:1.25;">Dricus Du Plessis</div><div style="font-size:13px;color:#9aa0a6;">Avg. card placement 1.0</div></div></div>
<ol>
...
<li>Kamaru Usman: <strong>1.3</strong></li>
...
<li>Michael Venom Page: <strong>3</strong></li>
...
<li>Paddy Pimblett: <strong>1.7</strong></li>
...
<li>Nazim Sadykhov: <strong>5.7</strong></li>
...
<li>Nate Landwehr: <strong>4.7</strong></li>
</ol>
</div>
</div>
...
<div class="division-col">
<h3>Big Event Fighters</h3>
<div style="display:flex;align-items:center;gap:14px;margin:14px 0 22px;padding:14px 16px;border:1px solid #2b2b2b;border-radius:14px;background:linear-gradient(135deg,#1b1b1b,#0f0f0f);"><img src="https://pub-7bef67fde2894e1eb3061dee36bde224.r2.dev/fighters/merab-dvalishvili-b45b61b3.png" alt="Merab Dvalishvili" width="72" height="72" loading="lazy" style="width:72px;height:72px;border-radius:12px;object-fit:cover;background:#262626;flex:none;" /><div style="min-width:0;"><div style="font-size:18px;font-weight:700;color:#fff;line-height:1.25;">Merab Dvalishvili</div><div style="font-size:13px;color:#9aa0a6;">Avg. card placement 1.3</div></div></div>
<ol>
<li>Merab Dvalishvili: <strong>1.3</strong></li>
<li>Cory Sandhagen: <strong>2</strong></li>
<li>Sean O'Malley: <strong>2</strong></li>
<li>Mario Bautista: <strong>2.3</strong></li>
<li>Jose Aldo: <strong>2.7</strong></li>
<li>Henry Cejudo: <strong>3</strong></li>
<li>Umar Nurmagomedov: <strong>4</strong></li>
<li>Payton Talbott: <strong>5</strong></li>
<li>Raul Rosas Jr.: <strong>5.7</strong></li>
<li>Patchy Mix: <strong>6</strong></li>
<li>Cody Garbrandt: <strong>6.3</strong></li>
<li>Farid Basharat: <strong>12</strong></li>
</ol>
</div>
<div class="division-col">
<h3>Fight Night Fighters</h3>
...
<li>David Martinez: <strong>2.3</strong></li>
...
<li>Raoni Barcelos: <strong>6</strong></li>
</ol>
</div>
</div>
...
<li>Brandon Royval: <strong>2.7</strong></li>
<li>Clayton Carpenter: <strong>11.3</strong></li>
<li>Cody Durden: <strong>14.3</strong></li>
</ol>
</div>
<div class="division-col">
<h3>Fight Night Fighters</h3>
...
<li>Lone’er Kavanagh: <strong>2.5</strong></li>
<li>Steve Erceg: <strong>2.7</strong></li>
...
<li>Ramazan Temirov: <strong>6.3</strong></li>
...
<li>Dione Barbosa: <strong>15.7</strong></li>
</ol>
</div>
</div>
...
<li>Eduarda Moura: <strong>10.7</strong></li>
</ol>
</div>
</div>
