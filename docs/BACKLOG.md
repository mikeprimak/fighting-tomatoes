...
- [ ] `M` 🟢 **SEO/P6: first link-earning data article — "Hype vs. reality, 2026 so far" (2026-07-17 design session)** → original-data story from our hype-vs-rating gap (most overhyped / most underrated fights of H1 2026), built to be cited: stat callouts, watermarked embeddable charts. Claude drafts article + individual pitch emails to MMA journalists; **Mike sends the pitches directly — Reddit is NOT a channel (his posts get removed)**. Article rules apply: draft + stop for review (`feedback_article_review_before_ship`), no AI tells. Quarterly cadence thereafter.
