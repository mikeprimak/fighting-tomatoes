...
- [ ] `M` 🟢 **Add-to-calendar + subscribable fight calendar (2026-07-21, user request: "merge this app with your fight calendar… would go mega viral")** → Two layers, both server-side ICS (no new deps — ICS is plain text; no `expo-calendar`, no native build):
